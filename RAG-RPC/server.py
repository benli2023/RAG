...
EMBEDDING_MODEL_NAME = os.getenv("EMBEDDING_MODEL_NAME", os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "my_local_bge_m3"))
...
class VectorDatabaseServicer(pb2_grpc.VectorDatabaseServiceServicer):
    ...
    def SimilaritySearch(self, request, context):
        ...
        for d in docs:
            ...
            response.documents.append(pb2.Document(
...
def serve():
    ...
    # Start server with secure port (HTTPS equivalent for gRPC)
